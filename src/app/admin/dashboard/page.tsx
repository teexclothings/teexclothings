        ...
        {SHORTCUTS.map((item) => {
          ...
          return (
            <Link
              key={item.href}
              href={item.href}
              className="group relative flex flex-col justify-between border border-neutral-200 dark:border-neutral-800 bg-neutral-50/50 dark:bg-neutral-50 dark:bg-neutral-900/50 p-6 rounded-sm transition-all hover:border-black dark:hover:border-white hover:bg-neutral-50 dark:bg-neutral-900"
            >
              <div>
