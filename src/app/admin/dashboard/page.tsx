        ...
        {SHORTCUTS.map((item) => {
          ...
          return (
            <Link
              key={item.href}
              href={item.href}
              className="group relative flex flex-col justify-between border border-neutral-800 bg-neutral-900/50 p-6 rounded-sm transition-all hover:border-white hover:bg-neutral-900"
            >
              <div>
                <div className="flex h-10 w-10 items-center justify-center border border-neutral-800 bg-neutral-950 text-neutral-400 transition-colors group-hover:border-white group-hover:text-white rounded-sm">
                  <Icon size={14} />
                </div>
                <h3 className="mt-4 text-xs font-semibold uppercase tracking-widest text-white">
                  {item.label}
                </h3>
                <p className="mt-2 text-xs font-light leading-relaxed text-neutral-400">
                  {item.desc}
              ...
              <div className="mt-6 flex items-center justify-between text-[9px] uppercase tracking-widest text-neutral-500 transition-colors group-hover:text-white">
                <span>Manage</span>
